...
Please write your proposal in a Google Doc (shared with comment access to anyone with the link) and submit a link to you proposal via [this form](https://forms.gle/T7EhpQUxRwjSYdM38).  We'll provide feedback as in-line comments, which can be more convenient than an email thread.
...
Please submit your PDF (and your project's code) to your course GitHub if working alone or to a team repo if in a group and then complete [this form](https://forms.gl/not_yet).
